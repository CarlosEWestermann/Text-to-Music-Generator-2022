...
public class translationConstants {
    ...
    public static final char LowerU = 'u';
    public static final char UpperI = 'I';
    public static final char LowerI = 'i';
    public static final char LowerA = 'a';
    public static final char LowerB = 'b';
    public static final char LowerC = 'c';
    public static final char LowerD = 'd';
